...
function sendDataToThingSpeak(latitude, longitude) {
    var apiKey = "OJ5QIA0SXXFLF73V"; // Insert your ThingSpeak API key here
    var apiUrl = "https://api.thingspeak.com/update?api_key=" + apiKey + "&field1=" + latitude + "&field2=" + longitude;
...
function fetchThingSpeakData() {
    var apiKey = "OJ5QIA0SXXFLF73V"; // Insert your ThingSpeak API key here
    var apiUrl = "https://api.thingspeak.com/channels/2517667/feeds.json?api_key=" + apiKey + "&results=1";
